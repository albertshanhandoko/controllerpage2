...
namespace ControllerPage
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            /*
             * string IP_Address_Create;

            if (String.IsNullOrEmpty(textBox_IPAddress.Text))
            {
                IP_Address_Create = "192.168.0." + rand_num.ToString();
            }
            else
            {
                IP_Address_Create = textBox_IPAddress.Text;
            }
            */
            ...
            Thread.Sleep(500);
            timer_counter = 1;
            batch_id = Sensor_input_Helper.MySql_Insert_Batch(Sensor_input_Helper.GetLocalIPAddress() ,"test Product", TotalInterval
                , combox_timeinteval, Int32.Parse(combox_numbergrain),result_temp );
